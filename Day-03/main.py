...
if answer == "left":
  ...
  answer_3 = input("""You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour do you choose? """).lower()
  if answer_3 == "yellow":
    ...
    print("The door you choose is not exist.")
else:
